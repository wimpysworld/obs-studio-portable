...
```bash
wget "https://github.com/wimpysworld/obs-studio-portable/releases/download/r22305/obs-portable-28.0.3-r22305-ubuntu-$(lsb_release -rs).tar.bz2"
wget "https://github.com/wimpysworld/obs-studio-portable/releases/download/r22305/obs-portable-28.0.3-r22305-ubuntu-$(lsb_release -rs).tar.bz2.sha256"
sha256sum -c obs-portable-28.0.3-r22305-ubuntu-$(lsb_release -rs).tar.bz2.sha256
tar xvf obs-portable-28.0.3-r22305-ubuntu-$(lsb_release -rs).tar.bz2
cd obs-portable-28.0.3-r22305-ubuntu-$(lsb_release -rs)
./obs-dependencies
./obs-portable
```
...
An OBS Studio Portable for Ubuntu release number will be something like r22305,
...
```text
                     ...
                     |
                     v
obs-portable-28.0.3-r22305-ubuntu-22.04.tar.bz2
              ^                    ^
              |                    |
